...
bondDiscountingTermStructure = ql.PiecewiseLogLinearDiscount(settlementDate, bondInstruments, termStructureDayCounter)
...
depoSwapTermStructure = ql.PiecewiseLogLinearDiscount(settlementDate, depoSwapInstruments, termStructureDayCounter)
...
vol = ql.OptionletVolatilityStructureHandle(
    ql.ConstantOptionletVolatility(settlementDays, calendar, ql.ModifiedFollowing, volatility, ql.Actual365Fixed())
)
